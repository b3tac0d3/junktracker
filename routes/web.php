...
$router->get('/reports/snapshot', [ReportsController::class, 'snapshot']);
$router->post('/reports/snapshot/save', [ReportsController::class, 'saveSnapshot']);
...
$router->get('/site-admin/users', [UsersController::class, 'index']);
$router->get('/site-admin/users/new', [UsersController::class, 'create']);
$router->get('/site-admin/users/{id}/edit', [UsersController::class, 'edit']);
$router->get('/site-admin/users/{id}/activity', [UsersController::class, 'activity']);
$router->get('/site-admin/users/{id}/logins', [UsersController::class, 'logins']);
$router->get('/site-admin/users/{id}', [UsersController::class, 'show']);
$router->post('/site-admin/users', [UsersController::class, 'store']);
$router->post('/site-admin/users/{id}', [UsersController::class, 'update']);
$router->post('/site-admin/users/{id}/invite-auto-accept', [UsersController::class, 'autoAcceptInvite']);
$router->post('/site-admin/users/{id}/deactivate', [UsersController::class, 'deactivate']);
...
$router->post('/site-admin/exit-business', [SiteAdminController::class, 'exitBusinessContext']);
