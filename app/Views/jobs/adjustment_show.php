    ...
    <div class="jt-page-header-actions d-grid gap-2 d-md-flex d-md-flex-wrap justify-content-md-end align-items-md-center">
        <div class="dropdown w-100 w-md-auto">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="<?= e(url('/jobs/' . (string) $jobId . '/adjustments/' . (string) $adjustmentId . '/edit')) ?>"><i class="fas fa-pen me-2"></i>Edit</a></li>
                <li>
                    <form method="post" action="<?= e(url('/jobs/' . (string) $jobId . '/adjustments/' . (string) $adjustmentId . '/delete')) ?>" class="m-0" onsubmit="return confirm('Delete this adjustment?');">
                        <?= csrf_field() ?>
