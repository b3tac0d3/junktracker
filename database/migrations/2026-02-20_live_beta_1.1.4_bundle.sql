-- JunkTracker Beta 1.1.4 Live Bundle
-- Generated: 2026-02-19 10:14:00 EST
...
-- Beta 1.1.4 release marker (no additional schema changes beyond bundled statements above)
CREATE TABLE IF NOT EXISTS schema_migrations (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    migration_key VARCHAR(190) NOT NULL,
    checksum VARCHAR(64) NULL,
...
INSERT IGNORE INTO schema_migrations (migration_key, checksum, applied_at) VALUES
('2026-02-20_live_beta_1.1.4_bundle', 'live-beta-1.1.4', NOW());
