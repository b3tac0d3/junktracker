-- Live 1.7.2: normalize form_select_values soft-delete/audit columns.
-- Idempotent. Same checks as 2026-04-24_live_1.7.1.sql — safe to run if 1.7.1 was already applied.
